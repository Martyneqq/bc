...
(281, 1, '654321', '654321', '2024-11-05', '2024-11-05', 'Výdaj', 'Ne', 654321, 'Hmotný', 'Banka', 2, 'Rovnoměrný', '', 'Odpis', 0),
(282, 1, '654321', '654321', '2024-11-05', '2024-11-05', 'Výdaj', 'Ne', 654321, 'Hmotný', 'Banka', 2, 'Rovnoměrný', '', 'Odpis', 0),
(283, 1, '951', '156+9+', '2020-01-08', '2024-11-05', 'Výdaj', 'Ne', 951000, 'Hmotný', 'Banka', 3, 'Rovnoměrný', '', 'Odpis', 0);
...
(0, '951', '156+9+', 1, 1, 283, 52305, 52305, 0, '2020-12-31', 'Rovnoměrný', 'Výdaj', 'Ano', '', 'Banka', 898695, 'Odpis'),
(0, '951', '156+9+', 1, 2, 283, 99855, 99855, 0, '2021-12-31', 'Rovnoměrný', 'Výdaj', 'Ano', '', 'Banka', 798840, 'Odpis'),
(0, '951', '156+9+', 1, 3, 283, 99855, 99855, 0, '2022-12-31', 'Rovnoměrný', 'Výdaj', 'Ano', '', 'Banka', 698985, 'Odpis'),
(0, '951', '156+9+', 1, 4, 283, 99855, 99855, 0, '2023-12-31', 'Rovnoměrný', 'Výdaj', 'Ano', '', 'Banka', 599130, 'Odpis');
...
INSERT INTO `demanddebt` (`id`, `userID`, `nazev`, `cislodoklad`, `firma`, `datum`, `datums`, `pohledavkadluh`, `hodnota`, `dan`, `uhrazeno`, `uhrada`, `doklad`, `popis`) VALUES
(1, 1, 'Kredit', '0', 'Vodafone', '2022-11-28', '2024-11-06', 'Pohledávka', 1449, 'Ano', 'Ano', 'Banka', '123', ''),
...
('Kredit', '', '2022-11-28', 'Příjem', 1449, 'Ano', 'Banka', '', 1, 1, NULL, ''),
